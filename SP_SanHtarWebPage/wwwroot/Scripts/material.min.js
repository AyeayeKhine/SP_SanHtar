...
var componentHandler = (function() {
  ...
  function t(i, n) {
    if (void 0 === i && void 0 === n)
      ...
      for (var r = document.querySelectorAll("." + n), o = 0; o < r.length; o++)
        s(r[o], i);
    }
  }
  function s(t, s) {
  ...
  function i(t) {
    ...
    if (
      ...
      throw "MDL component classes must not have " +
        c +
...
window.addEventListener("load", function() {
  ...
  (MaterialMenu.prototype.init = function() {
    ...
    if (this.element_) {
      ...
      for (
        ...
        n[a].addEventListener("click", this.handleItemClick_.bind(this)),
          (n[a].tabIndex = "-1"),
  ...
  (MaterialMenu.prototype.handleItemClick_ = function(e) {
    "use strict";
    null !== e.target.getAttribute("disabled")
      ? e.stopPropagation()
      : ((this.closing_ = !0),
        window.setTimeout(
          function(e) {
  ...
  (MaterialMenu.prototype.applyClip_ = function(e, t) {
    "use strict";
    this.element_.style.clip = this.element_.classList.contains(
  ...
  (MaterialMenu.prototype.show = function(e) {
    ...
    if (this.element_ && this.container_ && this.outline_) {
      ...
      var r = function(t) {
        t === e ||
          this.closing_ ||
          (document.removeEventListener("click", r), this.hide());
      }.bind(this);
  ...
  (MaterialRadio.prototype.updateClasses_ = function(e, t) {
    "use strict";
    e.disabled
      ? t.classList.add(this.CssClasses_.IS_DISABLED)
      : t.classList.remove(this.CssClasses_.IS_DISABLED),
      e.checked
        ? t.classList.add(this.CssClasses_.IS_CHECKED)
        : t.classList.remove(this.CssClasses_.IS_CHECKED);
  }),
  ...
  (MaterialSlider.prototype.updateValueStyles_ = function(e) {
    ...
    0 === t
      ...
      this.isIE_ ||
        ((this.backgroundLower_.style.flex = t),
        (this.backgroundLower_.style.webkitFlex = t),
        (this.backgroundUpper_.style.flex = 1 - t),
        (this.backgroundUpper_.style.webkitFlex = 1 - t));
  }),
  ...
  (MaterialTabs.prototype.initTabs_ = function(e) {
    ...
    for (var t = 0; t < this.tabs_.length; t++)
      new MaterialTab(this.tabs_[t], this);
  ...
  (MaterialTooltip.prototype.handleMouseEnter_ = function(e) {
    ...
    (this.element_.style.left = t.left + t.width / 2 + "px"),
      (this.element_.style.marginLeft =
        -1 * (this.element_.offsetWidth / 2) + "px"),
  ...
  (MaterialLayout.prototype.init = function() {
    ...
    if (this.element_) {
      ...
      for (var t = this.element_.childNodes, s = 0; s < t.length; s++) {
        var i = t[s];
        i.classList &&
          i.classList.contains(this.CssClasses_.HEADER) &&
          (this.header_ = i),
          i.classList &&
            i.classList.contains(this.CssClasses_.DRAWER) &&
            (this.drawer_ = i),
          i.classList &&
            i.classList.contains(this.CssClasses_.CONTENT) &&
            (this.content_ = i);
      }
      this.header_ &&
      ...
      if (
        ...
        this.header_ &&
          ...
          n === this.Mode_.STANDARD
            ? (this.header_.classList.add(this.CssClasses_.CASTING_SHADOW),
              this.tabBar_ &&
                this.tabBar_.classList.add(this.CssClasses_.CASTING_SHADOW))
            : n === this.Mode_.SEAMED || n === this.Mode_.SCROLL
              ? (this.header_.classList.remove(this.CssClasses_.CASTING_SHADOW),
                this.tabBar_ &&
        ...
        l.classList.add(this.CssClasses_.ICON),
          (l.textContent = this.Constant_.MENU_ICON),
          a.appendChild(l),
          a.addEventListener("click", this.drawerToggleHandler_.bind(this)),
          this.element_.classList.add(this.CssClasses_.HAS_DRAWER),
          this.element_.classList.contains(this.CssClasses_.FIXED_HEADER)
            ? this.header_.insertBefore(a, this.header_.firstChild)
            : this.element_.insertBefore(a, this.content_);
        var r = document.createElement("div");
        r.classList.add(this.CssClasses_.OBFUSCATOR),
      ...
      if (this.header_ && this.tabBar_) {
        ...
        o.classList.add(this.CssClasses_.TAB_CONTAINER),
          this.header_.insertBefore(o, this.tabBar_),
          this.header_.removeChild(this.tabBar_);
        var _ = document.createElement("div");
        _.classList.add(this.CssClasses_.TAB_BAR_BUTTON),
          _.classList.add(this.CssClasses_.TAB_BAR_LEFT_BUTTON);
        var d = document.createElement("i");
        d.classList.add(this.CssClasses_.ICON),
          (d.textContent = this.Constant_.CHEVRON_LEFT),
          _.appendChild(d),
          _.addEventListener(
            "click",
            function() {
        ...
        h.classList.add(this.CssClasses_.TAB_BAR_BUTTON),
          h.classList.add(this.CssClasses_.TAB_BAR_RIGHT_BUTTON);
        ...
        for (
          var p = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB),
            C = this.content_.querySelectorAll("." + this.CssClasses_.PANEL),
            m = 0;
          m < p.length;
          m++
        )
          new MaterialLayoutTab(p[m], p, C, this);
      }
      this.element_.classList.add(this.CssClasses_.IS_UPGRADED);
    }
  }),
  ...
  (MaterialDataTable.prototype.createCheckbox_ = function(e, t) {
    ...
    s.classList.add("mdl-checkbox"),
      s.classList.add("mdl-js-checkbox"),
      s.classList.add("mdl-js-ripple-effect"),
      s.classList.add("mdl-data-table__select");
    var i = document.createElement("input");
    return (
      (i.type = "checkbox"),
      i.classList.add("mdl-checkbox__input"),
      e
        ? i.addEventListener("change", this.selectRow_(i, e))
        : t && i.addEventListener("change", this.selectRow_(i, null, t)),
      s.appendChild(i),
      componentHandler.upgradeElement(s, "MaterialCheckbox"),
      s
    );
  }),
